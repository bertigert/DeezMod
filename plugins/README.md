...
### [Autofocus Main Window](./autofocus_main_window/)
...
### [Blacklist Songs](./blacklist_songs/)
...
### [Disable Live Connection](./disable_live_connection/)
...
### [Display All Songs](./display_all_songs/)
...
### [Enable Dev Mode](./enable_dev_mode/)
Enables DevMode which enables DevTool (ctrl+shift+i).

### [Exponential Volume](./enable_dev_mode/)
...
### [Toggle Features](./toggle_features/)
...
### [Webpack Patcher](./webpack_patcher/)
